...
export const REMOTE_ROUTES = Object.freeze([
  ...
  Object.freeze({ path: '/checkout/shipping', remoteId: REMOTE_IDS.CART }),
  Object.freeze({ path: '/checkout/payment', remoteId: REMOTE_IDS.CART }),
  Object.freeze({ path: '/order-confirmation', remoteId: REMOTE_IDS.CART }),
  Object.freeze({ path: '/login', remoteId: REMOTE_IDS.ACCOUNT }),
  Object.freeze({ path: '/register', remoteId: REMOTE_IDS.ACCOUNT }),
  Object.freeze({ path: '/profile', remoteId: REMOTE_IDS.ACCOUNT }),
  Object.freeze({ path: '/orders', remoteId: REMOTE_IDS.ACCOUNT }),
  Object.freeze({ path: '/wishlist', remoteId: REMOTE_IDS.ACCOUNT }),
])
